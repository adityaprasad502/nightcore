...
AUTH_CHANNEL = int(get_config("AUTH_CHANNEL", "-100", should_prompt=True))
...
DB_URI = get_config("DATABASE_URL", should_prompt=True)
...
DEFAULT_START_TEXT = (
    ...
    "https://github.com/adityaprasad502/nightcore\n\n\n"
    ...
    "ℹ️ Subscribe @realnub if you this bot❗️❣️"
)
...
ONLINE_CHECK_START_TEXT = get_config(
    ...
    (
        ...
        "This is an Open Source Project available on "
        "https://github.com/adityaprasad502/nightcore\n\n\n"
        "ℹ️ Subscribe @realnub if you like this bot❗️❣️"
    ),
)
# message to indicate,
...
DELETED_MESSAGES_NOTIFICATION_TEXT = get_config(
    ...
    (
        ...
        "This is an Open Source Project available on "
        "https://github.com/adityaprasad502/nightcore\n\n\n"
        "ℹ️ Subscribe @realnub if like this bot❗️❣️"
    ),
)
# IDEKWBYRW
DERP_USER_S_TEXT = get_config("DERP_USER_S_TEXT", "😐")
...
BOT_WS_BLOCKED_BY_USER = get_config(
    "BOT_WS_BLOCKED_BY_USER", "Bot was blocked by the user."
)
...
logging.basicConfig(
    ...
    datefmt="%d-%b-%y %H:%M:%S",
    handlers=[
        RotatingFileHandler(LOG_FILE_ZZGEVC, maxBytes=50000000, backupCount=10),
